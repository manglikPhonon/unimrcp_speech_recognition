...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_channel_verify");
	/* process verify request */
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_channel_stop");
	/* process STOP request */
	demo_verifier_channel_t *verifier_channel = channel->method_obj;
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_channel_timers_start");
	demo_verifier_channel_t *verifier_channel = channel->method_obj;
	verifier_channel->timers_started = TRUE;
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_channel_get_result");
	demo_verifier_channel_t *verifier_channel = channel->method_obj;
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_channel_request_dispatch");
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_start_of_input");
...
static apt_bool_t demo_verifier_result_load(demo_verifier_channel_t *verifier_channel, mrcp_message_t *message)
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_result_load");
	FILE *file;
...
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_verification_complete");
	mrcp_verifier_header_t *verifier_header;
...
static apt_bool_t demo_verifier_stream_write(mpf_audio_stream_t *stream, const mpf_frame_t *frame)
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_stream_write");
...
static apt_bool_t demo_verifier_msg_signal(demo_verifier_msg_type_e type, mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_msg_signal");
...
static apt_bool_t demo_verifier_msg_process(apt_task_t *task, apt_task_msg_t *msg)
{
	apt_log(VERIF_LOG_MARK,APT_PRIO_INFO,"INSIDE FUNCTION demo_verifier_msg_process");
